      ...
      <div className="container mx-auto px-6 py-12 max-w-7xl">
        ...
        <div
          className={`max-w-7xl mx-auto ${
            showSetupForm ? "grid grid-cols-1 xl:grid-cols-3 gap-12" : ""
          }`}
        >
          ...
          <div
            className={
              showSetupForm ? "xl:col-span-2" : "w-full max-w-6xl mx-auto"
            }
          >
            {joinUrl ? (
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 backdrop-blur-sm">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center space-x-6">
                      ...
                      <button
                        onClick={endCall}
                        className="bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 flex items-center space-x-2 shadow-lg hover:shadow-xl"
                      >
                        <svg
                          className="w-5 h-5"
                          fill="none"
                      ...
                      {transcripts.length === 0 ? (
                        <div className="text-center py-12">
                          <div className="flex justify-center space-x-12 mb-8">
                            ...
                            {/* User Avatar */}
                            <div className="flex flex-col items-center">
                              <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mb-3 relative">
                                <svg
